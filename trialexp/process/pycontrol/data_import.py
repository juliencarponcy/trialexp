...
# Code by Thomas Akam at:
# https://github.com/pyControl/code/blob/master/tools/data_import.py
# commit: https://github.com/pyControl/code/commit/5d046d8902aba1a96b7ef117eed97d677f8ce364

# Note from julien, for now only session_dataframe function appears to be used
# Other functions here have modified version in the "big" data_import at:
# trialexp\process\data_import.py, pre-snakemake pipelines
# We could consider simplyfing by only adding session_dataframe to utils.py
