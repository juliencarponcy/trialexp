...
(sinput, soutput) = getSnake(locals(), 'workflows/spout_bar_nov22.smk',
 ['Z:/Julien/Data/head-fixed/_Other/test_folder/by_session_folder/JC317L-2022-12-16-173145\processed/figures/photometry'],
...
sns.lineplot(x='rel_time_hold_for_water', y='analog_1_df_over_f', data=df2plot, ax=ax)
