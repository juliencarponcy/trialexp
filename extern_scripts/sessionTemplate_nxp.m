...
defaults.animal.species = 'Mouse'; % Mouse, Rat
defaults.animal.strain = 'C57BL/6';
...
defaults.extracellular.sr = 30000;           % Sampling rate of raw data
defaults.extracellular.srLfp = 2500;         % Sampling rate of LFP data
