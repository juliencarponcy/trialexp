...
# debug_folder = os.path.join(os.environ['SESSION_ROOT_DIR'], 'reaching_go_spout_bar_nov22', 'kms058-2023-03-20-132658')
debug_folder = os.path.join(os.environ['SESSION_ROOT_DIR'], 'reaching_go_spout_bar_nov22', 'kms058-2023-03-14-165110')

# debug_folder = os.path.join(os.environ['SESSION_ROOT_DIR'], 'reaching_go_spout_bar_nov22', 'kms058-2023-03-24-151254')
